...
namespace ZU.WPF.Data
{
	...
	{
		public static string DataContainer = "ZetUniverse.DataFormats.DataContainer";
		public static string AppSourceBoundFileSystemDataContainer = "ZetUniverse.DataFormats.AppSourceBoundFileSystemDataContainer";
