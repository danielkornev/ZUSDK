...
namespace System.Net
{
	public static class MimeTypeParser
	{
		...
		public static bool IsWebPage(string contentType)
		{
			bool result = false;

			List<string> webPageContentTypes = new List<string>();

			webPageContentTypes.Add("text/html");
			webPageContentTypes.Add("application/xhtml+xml");
			webPageContentTypes.Add("application/xml");

			foreach (var ct in webPageContentTypes)
			{
