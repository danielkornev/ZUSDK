...
namespace System.Windows
{
	...
	public static class RectExtensions
	{
		...
		/// <summary>
		/// Returns a new Rect3D based on the provided 2D rectangle and number of ticks (since MinValue).
		/// </summary>
		/// <param name="rect"></param>
		/// <param name="ticks"></param>
		/// <returns></returns>
		public static Rect3D ToRect3D(this Rect rect, double ticks)
		{
			return new Rect3D(rect.X, rect.Y, 0d, rect.Width, rect.Height, ticks);
		}
	} // class
} // namespace